...
sudo curl -sL --output /etc/systemd/system/demoapp.service https://raw.githubusercontent.com/github-owen-yang/vdc-networking-lab/master/nested/demoapp.service
...
curl --silent https://raw.githubusercontent.com/github-owen-yang/vdc-networking-lab/master/nested/.bashrc > ~labuser/.bashrc
